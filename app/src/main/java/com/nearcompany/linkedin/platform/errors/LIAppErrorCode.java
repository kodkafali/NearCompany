...
public enum LIAppErrorCode {
    ...
    private static final Map<String, LIAppErrorCode> liAuthErrorCodeHashMap = LIAppErrorCode.buildMap();
    ...
    public static LIAppErrorCode findErrorCode(String errorCode) {
        LIAppErrorCode liAuthErrorCode = LIAppErrorCode.liAuthErrorCodeHashMap.get(errorCode);
        return liAuthErrorCode == null ? LIAppErrorCode.UNKNOWN_ERROR : liAuthErrorCode;
    }
